...
<<<<<<< HEAD
                2$^{\rm nd}$ descriptions in the warm-up train data,
                activity1.mat. $\bm{A}$ should be a 2$\times m$ matrix where
                $m$ is the number of unique words between the two
=======
...
>>>>>>> 2d0684dddae8cba814aa8296efadd4cb7b53a31d
