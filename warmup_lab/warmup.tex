...
% ------------------------------------------------------------------------------
    ...
    \begin{equation}
    \hat{x} = \texttt{pinv}(A)*b % I don't want to introduce the svd in the warmup, but the inverse does not work...
    \end{equation}
    ...
    \begin{center} 
        ...
        \fbox{\begin{minipage}{40em}
            ...
            $\bm{b}$ should be a 2$\times$1 matrix. Verify the above solution
            for $\bm{\hat{x}}$.
    ...
    The estimated salary is \$3032.80. About \$41,967 different from the true %when I run I find this; I think Elijah missed the decimal?
